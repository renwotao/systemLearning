...
/*
 ...
 @param idx which (one proc has more than one segment)
...
/*
 ...
 param p The mesage to be cleared.
*/
...
/*
 ...
 will be blocked and appended the dest's sending queue.
...
PRIVATE int msg_receive(struct proc* current, int src, MESSAGE* m)
{
	/* This name is a little bit wierd, but it makes me think clearly,
	 so I keep it.*/
	...
	{
		/* There is an interrupt needs p_whom_wanna_recv's handling
