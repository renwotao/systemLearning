...
LABEL_SEARCH_IN_ROOT_DIR_BEGIN:
	...
	mov	ax, [wSectorNo]
	mov	cl, 1
	call	ReadSector	; 读取扇区中内容放在es:di
				; = BaseOfKernelFile:OffsetOfKernelFile
...
; InitKernel-----------------------------------------------------------------
; 将 KERNEL.BIN 的内容经过整理对其后防盗新的位置
; 遍历每一个Program Header, 根据 Program Header 中的信息来确定把什么放进内存，放到什么位置，以及放多少
; ----------------------------------------------------------------------------
InitKernel:
        xor   esi, esi
